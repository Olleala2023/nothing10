...
const checklistData = {
  slug: 'sleep-winddown',
  title: 'Sleep Wind-Down — 4 Minutes',
  intro: 'A tiny routine to downshift. No metrics, just calm.',
  duration: '4 minutes',
  steps: [
    { text: 'Lights: dim. Screen: lowest brightness.', required: false },
    { text: 'Put phone on airplane/DND.', required: false },
    { text: '1 minute: box breathing (4-4-4-4).', required: false },
    { text: '30 s: loosen jaw/forehead/shoulders.', required: false },
    { text: 'Note one thought to park till morning.', required: false },
    { text: 'Note one tiny action for tomorrow.', required: false },
    { text: 'Close apps; place phone away from bed.', required: false },
    { text: 'Lie down; slow three breaths.', required: false }
  ]
};
